...
const validatingState =
    document.getElementById("validatingState");
...
function mostrarEnlaceInvalido() {
    ...
    validatingState.textContent =
        "El enlace de recuperación es inválido o venció. Solicitá uno nuevo desde la pantalla de ingreso.";
}
...
function establecerCargando(cargando) {
    ...
    submitButtonText.textContent = cargando
        ? "Guardando..."
        : "Guardar contraseña";
